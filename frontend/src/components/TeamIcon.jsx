...
const TEAM_CONFIGS = {
  ...
  // NFL (32 equipos, colores oficiales confirmados contra las paletas de marca de cada equipo)
  "Arizona Cardinals": { bg: "linear-gradient(135deg, #97233f 0%, #000000 100%)", icon: "🐦", text: "#ffffff", border: "#ff5252" },
  "Atlanta Falcons": { bg: "linear-gradient(135deg, #a71930 0%, #000000 100%)", icon: "🦅", text: "#ffffff", border: "#ff5252" },
  "Baltimore Ravens": { bg: "linear-gradient(135deg, #241773 0%, #000000 100%)", icon: "🐦‍⬛", text: "#ffffff", border: "#9e7fff" },
  "Buffalo Bills": { bg: "linear-gradient(135deg, #00338d 0%, #c60c30 100%)", icon: "🦬", text: "#ffffff", border: "#40c4ff" },
  "Carolina Panthers": { bg: "linear-gradient(135deg, #0085ca 0%, #101820 100%)", icon: "🐆", text: "#ffffff", border: "#40c4ff" },
  "Chicago Bears": { bg: "linear-gradient(135deg, #0b162a 0%, #c83803 100%)", icon: "🐻", text: "#ffffff", border: "#ff8a50" },
  "Cincinnati Bengals": { bg: "linear-gradient(135deg, #fb4f14 0%, #000000 100%)", icon: "🐯", text: "#ffffff", border: "#ff8a50" },
  "Cleveland Browns": { bg: "linear-gradient(135deg, #311d00 0%, #ff3c00 100%)", icon: "🐕", text: "#ffffff", border: "#ff8a50" },
  "Dallas Cowboys": { bg: "linear-gradient(135deg, #041e42 0%, #869397 100%)", icon: "⭐", text: "#ffffff", border: "#40c4ff" },
  "Denver Broncos": { bg: "linear-gradient(135deg, #fb4f14 0%, #002244 100%)", icon: "🐴", text: "#ffffff", border: "#ff8a50" },
  "Detroit Lions": { bg: "linear-gradient(135deg, #0076b6 0%, #b0b7bc 100%)", icon: "🦁", text: "#ffffff", border: "#40c4ff" },
  "Green Bay Packers": { bg: "linear-gradient(135deg, #203731 0%, #ffb612 100%)", icon: "🧀", text: "#ffffff", border: "#ffb612" },
  "Houston Texans": { bg: "linear-gradient(135deg, #03202f 0%, #a71930 100%)", icon: "🤠", text: "#ffffff", border: "#ff5252" },
  "Indianapolis Colts": { bg: "linear-gradient(135deg, #002c5f 0%, #a2aaad 100%)", icon: "🐴", text: "#ffffff", border: "#40c4ff" },
  "Jacksonville Jaguars": { bg: "linear-gradient(135deg, #101820 0%, #d7a22a 100%)", icon: "🐆", text: "#ffffff", border: "#d7a22a" },
  "Kansas City Chiefs": { bg: "linear-gradient(135deg, #e31837 0%, #ffb81c 100%)", icon: "🏹", text: "#ffffff", border: "#ffb81c" },
  "Las Vegas Raiders": { bg: "linear-gradient(135deg, #000000 0%, #a5acaf 100%)", icon: "☠️", text: "#ffffff", border: "#a5acaf" },
  "Los Angeles Chargers": { bg: "linear-gradient(135deg, #0080c6 0%, #ffc20e 100%)", icon: "⚡", text: "#ffffff", border: "#ffc20e" },
  "Los Angeles Rams": { bg: "linear-gradient(135deg, #003594 0%, #ffa300 100%)", icon: "🐏", text: "#ffffff", border: "#ffa300" },
  "Miami Dolphins": { bg: "linear-gradient(135deg, #008e97 0%, #fc4c02 100%)", icon: "🐬", text: "#ffffff", border: "#00e676" },
  "Minnesota Vikings": { bg: "linear-gradient(135deg, #4f2683 0%, #ffc62f 100%)", icon: "⚔️", text: "#ffffff", border: "#ffc62f" },
  "New England Patriots": { bg: "linear-gradient(135deg, #002244 0%, #c60c30 100%)", icon: "🎖️", text: "#ffffff", border: "#40c4ff" },
  "New Orleans Saints": { bg: "linear-gradient(135deg, #101820 0%, #d3bc8d 100%)", icon: "⚜️", text: "#ffffff", border: "#d3bc8d" },
  "New York Giants": { bg: "linear-gradient(135deg, #0b2265 0%, #a71930 100%)", icon: "🗽", text: "#ffffff", border: "#40c4ff" },
  "New York Jets": { bg: "linear-gradient(135deg, #125740 0%, #000000 100%)", icon: "✈️", text: "#ffffff", border: "#00e676" },
  "Philadelphia Eagles": { bg: "linear-gradient(135deg, #004c54 0%, #a5acaf 100%)", icon: "🦅", text: "#ffffff", border: "#00e676" },
  "Pittsburgh Steelers": { bg: "linear-gradient(135deg, #ffb612 0%, #101820 100%)", icon: "⚙️", text: "#ffffff", border: "#ffb612" },
  "San Francisco 49ers": { bg: "linear-gradient(135deg, #aa0000 0%, #b3995d 100%)", icon: "⛏️", text: "#ffffff", border: "#ff5252" },
  "Seattle Seahawks": { bg: "linear-gradient(135deg, #002244 0%, #69be28 100%)", icon: "🦅", text: "#ffffff", border: "#69be28" },
  "Tampa Bay Buccaneers": { bg: "linear-gradient(135deg, #d50a0a 0%, #34302b 100%)", icon: "🏴‍☠️", text: "#ffffff", border: "#ff5252" },
  "Tennessee Titans": { bg: "linear-gradient(135deg, #0c2340 0%, #4b92db 100%)", icon: "⚔️", text: "#ffffff", border: "#4b92db" },
  "Washington Commanders": { bg: "linear-gradient(135deg, #5a1414 0%, #ffb612 100%)", icon: "🎖️", text: "#ffffff", border: "#ffb612" },
};
